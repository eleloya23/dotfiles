...
chmod +x $PWD/defaults/osxconfig
/$PWD/defaults/osxconfig

cout "Set up postgres"
initdb /usr/local/var/postgres -E utf8 >/dev/null 2>&1
 
cout "Start service automatically"
